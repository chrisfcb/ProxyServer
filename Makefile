...
ificp:
	scp anyReceiver.c binfile.c binfile.h binSender.c connection.c connection.h Makefile proxy.c record.c record.h recordFromFormat.c recordFromFormat.h recordToFormat.c recordToFormat.h xmlfile.c xmlfile.h xmlSender.c phbuhrs@login.ifi.uio.no:/uio/hume/student-u39/phbuhrs/IN2140/Kode/Hjemmeeksamen/
